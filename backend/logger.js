...
const trafficMetrics = new signale.Signale({ scope: "Traffic ", ...opts });
...
export { debug, global, migrate, express, access, nginx, ssl, certbot, importer, setup, ipRanges, remoteVersion, trafficMetrics };
